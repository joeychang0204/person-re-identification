#!/usr/bin/env bash
#export MARKET1501_DATA_ROOT=/scratch/user/linlaw0229/python_project/deep-person-reid/data/market1501
#export MARKET1501_TRAIN_LIST=/scratch/user/linlaw0229/python_project/deep-person-reid/data/market1501/bounding_box_train
# Set paths
source ./paths
